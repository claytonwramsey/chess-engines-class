...
impl Board {
    ...
    ///
    /// ```
    /// use coll110_hw3::base::{Board, Bitboard};
    ///
    /// let board = Board::new();
    ...
    ///
    /// ```
    /// use coll110_hw3::base::{Board, Piece, Square};
    ///
    /// let board = Board::new();
    ...
    ///
    /// ```
    /// use coll110_hw3::base::{Board, Color, Square};
    ///
    /// let board = Board::new();
    ...
    /// ```
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// use coll110_hw3::base::{Board, Move, Square};
    ///

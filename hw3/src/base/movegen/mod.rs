...
///
/// ```
/// use coll110_hw3::base::{movegen::KNIGHT_MOVES, Square, Bitboard};
///
...
///
/// ```
/// use coll110_hw3::base::{movegen::KING_MOVES, Square, Bitboard};
///
...
///
/// ```
/// use coll110_hw3::base::{movegen::PAWN_ATTACKS, Color, Square, Bitboard};
///
...
///
/// ```
/// use coll110_hw3::base::{Board, Move, movegen::is_legal, Square};
///
/// let board = Board::new();
...
/// ```
/// use coll110_hw3::base::{Board, movegen::{GenMode, is_legal, get_moves}};
///
/// let b = Board::new();
...
/// use coll110_hw3::base::{Board, Move, movegen::{GenMode, is_legal, get_moves}, Square};
///
...
/// }
/// ```
pub fn get_moves<const M: GenMode>(b: &Board) -> Vec<Move> {
    let mut moves;
...
///
/// ```
/// use coll110_hw3::base::{Board, movegen::has_moves};
///
/// let b = Board::new();
/// assert!(has_moves(&b));
/// ```
...
///
/// ```
/// use coll110_hw3::base::{Board, Square, Color, movegen::is_square_attacked_by};
///
/// let b = Board::new();
...
fn non_evasions<const M: GenMode>(b: &Board, moves: &mut Vec<Move>) {
    ...
    pawn_assistant::<M>(b, moves, pawn_targets);
...
fn evasions<const M: GenMode>(b: &Board, moves: &mut Vec<Move>) {
    let player = b.player;
    let king_sq = b.king_sqs[player as usize];
...
///
/// ```
/// use coll110_hw3::base::{Bitboard, Board, Square, Color, movegen::square_attackers};
///
/// let b = Board::new();
...
fn pawn_assistant<const M: GenMode>(b: &Board, moves: &mut Vec<Move>, target: Bitboard) {
    let board = &b;
    let player = b.player;
...
///
/// ```
/// use coll110_hw3::base::movegen::perft;
///
...
pub fn perft(fen: &str, depth: u8) -> u64 {
    ...
    fn helper<const DIVIDE: bool>(b: &Board, depth: u8) -> u64 {
        let moves = get_moves::<{ GenMode::All }>(b);
        if depth == 1 {
